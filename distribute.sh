...
generate_csr_json "system:node:node0" "node0" "\"192.168.50.12\", \"node0.kubernetes.local\", \"node0\"" "system:nodes"
generate_csr_json "system:node:node1" "node1" "\"192.168.50.13\", \"node1.kubernetes.local\", \"node1\"" "system:nodes"
